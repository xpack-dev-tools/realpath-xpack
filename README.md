...
[![NPM Version](https://img.shields.io/npm/v/@xpack-dev-tools/realpath?color=blue)](https://www.npmjs.com/package/@xpack-dev-tools/realpath/)
...
distribution of GNU realpath,
intended for reproducible builds.

## Project documentation

For information on how to install and use this project, please refer to the
[project website](https://xpack-dev-tools.github.io/realpath-xpack/).

## Project source

The source code of the current release is available on
[GitHub tag v9.5.0-1.1 tree](https://github.com/xpack-dev-tools/realpath-xpack/tree/v9.5.0-1.1).
