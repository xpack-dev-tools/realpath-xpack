---
title:  xPack GNU realpath v{{releaseVersion}} released
...
coreutils_version: "{{upstreamVersion}}"
coreutils_date: "{{customFields.coreutilsReleaseDate}}"

version: "{{releaseVersion}}"
npm_subversion: "1"

download_url: https://github.com/xpack-dev-tools/realpath-xpack/releases/tag/v{{releaseVersion}}/
