...
coreutils_date: "{{packageWebsiteConfig.coreutilsReleaseDate}}"

version: "{{xpackVersion}}"
npm_subversion: "1"

download_url: https://github.com/xpack-dev-tools/realpath-xpack/releases/tag/v{{xpackVersion}}/
...
[](https://ftpmirror.gnu.org/gnu/coreutils/) sources.
