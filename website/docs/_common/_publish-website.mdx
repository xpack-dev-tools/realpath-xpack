...
- **Push** the `website` branch to GitHub
  ...
  the [website](https://xpack-dev-tools.github.io/realpath-xpack/).
  :::
- Check out the `xpack-development` branch
- **Wait** for the publication to complete 
- check [GitHub Pages](https://github.com/xpack-dev-tools/realpath-xpack/actions/workflows/publish-github-pages.yml) workflow
...
Verify the result at https://xpack-dev-tools.github.io/realpath-xpack/.
