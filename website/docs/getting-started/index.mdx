...
title: Getting Started with xPack GNU realpath
...
**xPack GNU realpath** is a standalone
cross-platform (GNU/Linux, macOS)binary distribution of GNU realpath,
intended for reproducible builds.

<Overview/>

The open source **xPack GNU realpath** project is hosted on GitHub as
...
[release assets](https://github.com/xpack-dev-tools/realpath-xpack/releases).

In addition to the binary archives and the package metadata,
this project also includes the
[build scripts](https://github.com/xpack-dev-tools/realpath-xpack/tree/xpack/build-assets/scripts).
...
[GitHub Discussions](https://github.com/xpack-dev-tools/realpath-xpack/discussions/).
...
[`realpath-xpack.git/build-assets/scripts`](https://github.com/xpack-dev-tools/realpath-xpack/tree/xpack/build-assets/scripts/)
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/realpath-xpack/): It helps others discover our work.
