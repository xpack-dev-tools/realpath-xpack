...
**xPack GNU realpath** is a standalone cross-platform (Windows, macOS, GNU/Linux)
binary distribution of GNU realpath,
intended for reproducible builds.

<Overview/>

**xPack GNU realpath** is an open source project hosted on GitHub as
...
[build scripts](https://github.com/xpack-dev-tools/realpath-xpack/tree/xpack/scripts).
