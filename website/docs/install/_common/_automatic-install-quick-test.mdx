...
`% ~/Library/xPacks/@xpack-dev-tools/${props.permalinkName}/9.5.0-1.1/.content/bin/${props.programName} --version
${props.branding}9.5
`} </CodeBlock>
...
<CodeBlock language="console"> {
`$ ~/.local/xPacks/@xpack-dev-tools/${props.permalinkName}/9.5.0-1.1/.content/bin/${props.programName} --version
${props.branding}9.5
`} </CodeBlock>
