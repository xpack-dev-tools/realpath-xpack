...
The **xPack GNU realpath** may be installed automatically, utilising the `xpm` command
(the recommended method), or manually, by downloading and unpacking one of the
platform-specific archives.

## Automated installation

The easiest (and recommended) method to install xPack GNU realpath
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/xpack-dev-tools/realpath/9.8.0-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/xpack-dev-tools/realpath/9.8.0-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-realpath-9.8.0-1-darwin-x64.tar.gz</code></li>
<li><code>xpack-realpath-9.8.0-1-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/realpath/xpack-realpath-9.8.0-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/realpath
cd ~/Library/xPacks/realpath

tar xvf ~/Downloads/xpack-realpath-9.8.0-1-darwin-x64.tar.gz
chmod -R -w xpack-realpath-9.8.0-1
`} </CodeBlock>
...
<ul>
<li><code>xpack-realpath-9.8.0-1-linux-x64.tar.gz</code></li>
<li><code>xpack-realpath-9.8.0-1-linux-arm64.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/realpath/xpack-realpath-9.8.0-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/realpath
cd ~/.local/xPacks/realpath

tar xvf ~/Downloads/xpack-realpath-9.8.0-1-linux-x64.tar.gz
chmod -R -w xpack-realpath-9.8.0-1
`} </CodeBlock>
