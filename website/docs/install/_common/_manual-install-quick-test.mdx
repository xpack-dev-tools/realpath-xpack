...
`% ~/Library/xPacks/${props.permalinkName}/xpack-${props.permalinkName}-9.5.0-1/bin/${props.programName} --version
${props.branding}9.5
`} </CodeBlock>
...
<CodeBlock language="console"> {
`$ ~/.local/xPacks/${props.permalinkName}/xpack-${props.permalinkName}-9.5.0-1/bin/${props.programName} --version
${props.branding}9.5
`} </CodeBlock>
