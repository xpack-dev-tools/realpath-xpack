...
[![GitHub Release Date](https://img.shields.io/github/release-date/xpack-dev-tools/realpath-xpack)](https://github.com/xpack-dev-tools/realpath-xpack/releases/)
[![npm (scoped)](https://img.shields.io/npm/v/%40xpack-dev-tools%2Frealpath?label=xpm&color=blue)](https://www.npmjs.com/package/@xpack-dev-tools/realpath/)
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/xpack-dev-tools/realpath-xpack/total)
[![npm](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Frealpath?label=xpm%20downloads)](https://www.npmjs.com/package/@xpack-dev-tools/realpath/)
...
The command to install the **latest** available version of **realpath** is:
...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/realpath@${customField('version')} --verbose
`} </CodeBlock>
...
In order to access the GNU realpath binaries installed in
