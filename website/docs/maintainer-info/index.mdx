...
title: Information for xPack GNU realpath maintainers
...
```sh
bash ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-travis-macos.sh
```
...
named like **xPack GNU realpath v{ customField('upstreamVersion') }-{ customField('xpackSubversion') }** (mind the dash),
...
- <code>npm dist-tag ls @xpack-dev-tools/realpath</code>
- <code>npm dist-tag add @xpack-dev-tools/realpath@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') } latest</code>
- <code>npm dist-tag ls @xpack-dev-tools/realpath</code>

In case the previous version is not functional and needs to be unpublished:

- <code>npm unpublish @xpack-dev-tools/realpath@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') }</code>
...
- the result is in https://xpack-dev-tools.github.io/realpath-xpack/blog/
...
- paste the release name like _**xPack GNU realpath v{ customField('upstreamVersion') }-{ customField('xpackSubversion') } released**_
