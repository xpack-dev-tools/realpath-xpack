...
xpm run link-deps -C ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets

xpm run deep-clean --config darwin-x64  -C ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets && \
xpm install --config darwin-x64 -C ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets && \
xpm run build-development --config darwin-x64 -C ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets
```

For a debug build:

```sh
xpm run build-development-debug --config darwin-x64 -C ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets
```
...
```sh
xpm run check-space -C ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets
```
...
```sh
xpm run clear-all-projects-builds -C ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets
```
...
```sh
xpm run generate-workflows -C ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets
```
...
```sh
xpm run trigger-workflow-test-prime -C ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets
xpm run trigger-workflow-test-docker-linux-x64 -C ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets
xpm run trigger-workflow-test-docker-linux-arm -C ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets
```
...
```sh
xpm run trigger-travis-macos -C ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets
```
...
git -C ~/Work/xpack-dev-tools/realpath-xpack.git pull
xpm run install -C ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets
xpm run test-pre-release -C ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets
```
...
```sh
xpm run trigger-workflow-publish-release -C ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets
```
...
watching the realpath-xpack project.
...
```sh
xpm run generate-website-blog-post -C ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets
```
...
```sh
xpm run update-package-binaries -C ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets
```
...
<a href="https://www.npmjs.com/package/@xpack-dev-tools/realpath?activeTab=versions">npmjs.com</a>.
...
```sh
xpm run trigger-workflow-test-xpm -C ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets
```
...
in https://xpack-dev-tools.github.io/realpath-xpack/blog/
- remember the post URL, since it must be used to update the release page
and the X/Twitter announcement
- switch to https://xpack-dev-tools.github.io/realpath-xpack/docs/maintainer/#update-the-xpack-branch
...
```sh
xpm run trigger-workflow-deep-clean -C ~/Work/xpack-dev-tools/realpath-xpack.git/build-assets
```
...
[![Github All Releases](https://img.shields.io/github/downloads/xpack-dev-tools/realpath-xpack/latest/total)](https://github.com/xpack-dev-tools/realpath-xpack/releases)
  - all xPack releases [![Github All Releases](https://img.shields.io/github/downloads/xpack-dev-tools/realpath-xpack/total)](https://github.com/xpack-dev-tools/realpath-xpack/releases)
  - [individual file counters](https://somsubhra.github.io/github-release-stats/?username=xpack-dev-tools&repository=realpath-xpack) (grouped by release)
- npmjs.com [`@xpack-dev-tools/realpath`](https://www.npmjs.com/package/@xpack-dev-tools/realpath/) xPack
  - latest release, per month
[![npm (scoped)](https://img.shields.io/npm/v/@xpack-dev-tools/realpath)](https://www.npmjs.com/package/@xpack-dev-tools/realpath/)
[![npm](https://img.shields.io/npm/dm/@xpack-dev-tools/realpath)](https://www.npmjs.com/package/@xpack-dev-tools/realpath/)
  - all releases [![npm](https://img.shields.io/npm/dt/@xpack-dev-tools/realpath)](https://www.npmjs.com/package/@xpack-dev-tools/realpath/)
