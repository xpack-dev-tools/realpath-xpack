...
title: How to get help for realpath
...
# How to get help for xPack GNU realpath
...
distribution, not to the upstream GNU realpath itself
(if you have doubts, use the GitHub Discussions),
or if you have a pertinent suggestion how to enhance the **xPack GNU realpath**
