...
such as <code>9.8.0-<b>1</b></code>. When
published as an npm package, the version receives
a fifth number,
such as <code>9.8.0-1.<b>1</b></code>.

Since adherence of third-party packages to SemVer is not guaranteed,
it is recommended to avoid referencing the xPack GNU realpath dependency via
SemVer expressions
such as <code>^9.8.0-1</code> or <code>~9.8.0-1</code>, and
