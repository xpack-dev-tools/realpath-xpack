...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/xpack-dev-tools/realpath-xpack/edit/xpack/website/',
        ...
        sitemap: {
          ...
          priority: 0.5,
          ignorePatterns: [
            '/realpath-xpack/blog/archive/**',
            '/realpath-xpack/blog/authors/**',
            '/realpath-xpack/blog/tags/**'
          ],
  ...
  headTags: [
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/png',
        href: '/realpath-xpack/favicons/favicon-48x48.png',
        sizes: '48x48'
      }
    },
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/svg+xml',
        href: '/realpath-xpack/favicons/favicon.svg'
      }
    },
    {
      tagName: 'link',
      attributes: {
        rel: 'shortcut icon',
        href: '/realpath-xpack/favicons/favicon.ico'
      }
    },
    {
    ...
    },
    {
      ...
      attributes: {
        rel: 'manifest',
        href: '/realpath-xpack/favicons/site.webmanifest'
      }
    }
  ],
  ...
  themeConfig: {
    ...
    metadata: [
      {
        name: 'keywords',
        content: 'xpack, binary, development, tools, reproducibility, realpath'
      }
    ],
    navbar: {
      ...
      items: [
        ...
        },
        {
          ...
          position: 'right',
          href: `https://github.com/xpack-dev-tools/realpath-xpack/releases/tag/v${customFields.xpackVersion}`,
        },
      ],
    },
    footer: {
          ...
          items: [
            {
              ...
              href: 'https://github.com/xpack-dev-tools/realpath-xpack/discussions',
            },
            {
